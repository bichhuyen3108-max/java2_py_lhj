...
public class StringExample {
	...
	public static void main(String[] args) {
		...
		if(strVar1 == strVar2) {
			System.out.println("strVar1과 strVar2는 참조하고 있는 주소가 같다.")
			;
		}
		...
		//클랙스 변수명; -> 참조 변수(주소값을 주소값을 저장할 수 있다)
		//new -> 메모리에 공간을 확보해준다
		//클랙스명()-> 생선자 : 메모리에 객체를 생성해준다
		String strVar3 = new String("홍길동");
		String strVar4 = new String("홍길동");
		//new 생성자()로 만들면 무조건 heap영역애 새로 객체를 생선한다.
		// 객체마다 주소값이 다르다
		
		//같은 문자열이 있으면 다른 변수도 같은 주소를 참조한다
		if(strVar3 == strVar4) {
			System.out.println("strVar3과 strVar4는 참조하고 있는 주소가 같다.");
		}else {
			System.out.println("strVar3과 strVar4는 참조하고 있는 주소가 다르다.");
		}
		
		//equals()메서드는 주소가 아닌 문자열 값이 같은지 비교한다.
		...
		//같은 주소를 참조하고 있어도 값이 바뀔 때 s2의 값은 자끠지 않는다
		...
		//없는 값을 달라고 하면 -1을 잔환한다
		
		//문자열을 구분자를 이용하여 여러개로 분리하는것
		//split(구분자)
		String board = "번호,베목,내용,설명";
