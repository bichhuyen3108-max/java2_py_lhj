...
public class PatternExample {
	...
	public static void main(String[] args) {
		...
		data = "010-1234-5678";
		System.out.println("전화번허 형시: "+ Pattern.matches(regex, data));
